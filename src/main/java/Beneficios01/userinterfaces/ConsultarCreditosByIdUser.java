...
public class ConsultarCreditosByIdUser {
    ...
    public static final Target BOX_CONSULTAR_CRED_NAME=Target.the("BOX PARA VER POR NOMBRE").locatedBy("(//*[@class='p-inputtext p-component p-element ng-star-inserted'])[3]");
